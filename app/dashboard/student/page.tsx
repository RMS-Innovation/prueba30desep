...
export default async function StudentDashboardPage() {
  ...
  if (profileError || enrollmentsError) {
    console.error(
      ...
      (profileError as any)?.message || (enrollmentsError as any)?.message,
    )
  }
  ...
  const averageProgress =
    recentEnrollments.length > 0
      ? Math.round(
          recentEnrollments.reduce((sum, enrollment) => sum + (enrollment.progress_percentage ?? 0), 0) /
        ...
        <div className="p-6">
          ...
          <div className="mb-8">
            <div className="flex items-center space-x-4 mb-4">
              ...
              <div>
                <h1 className="text-3xl font-bold text-gray-900">¡Bienvenido de vuelta, {userName}!</h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="space-y-6">
              <Card>
                <CardHeader>
                  <CardTitle className="flex items-center">
                    <TrendingUp className="w-5 h-5 mr-2" /> Progreso General
                  </CardTitle>
                </CardHeader>
                ...
                <Card>
                  ...
                  <CardContent>
                    <div className="text-center">
                      ...
                      <h3 className="font-semibold text-gray-900 mb-1">{nextCertificateCourse.courses.title}</h3>
                      <Link href={`/dashboard/student/course/${nextCertificateCourse.courses.id}`}>
                        <Button className="w-full bg-purple-800 hover:bg-purple-900">Continuar Curso</Button>
                      </Link>
                    </div>
                  </CardContent>
                </Card>
